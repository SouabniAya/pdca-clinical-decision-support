...
<aside class="sidebar">
  ...
  <nav class="sidebar__nav" aria-label="Main navigation">
    <ul>
      ...
      <li>
        <a href="<?php echo e(url('/patients')); ?>" <?php if($active === 'clinical-data'): ?> class="is-active" <?php endif; ?>>
...
</aside><?php /**PATH C:\laragon\www\medcare-clone\resources\views/components/sidebar.blade.php ENDPATH**/ ?>